...
- [x] **인증 구현 (Auth):**
    ...
    - [/] 검증 (Verification) <!-- id: 14 -->
        - [x] 주문 생성 확인 (Firestore) <!-- id: 15 -->
        - [x] OOTD 작성 모달에서 구매 내역 탭 확인 <!-- id: 16 -->
        - [ ] 구매한 상품 태그 기능 동작 확인 (Firestore Index 필요) <!-- id: 17 -->
- [ ] **Firebase 설정:** `firebase_checklist.md` 참고하여 콘솔 설정 완료.
- [x] **마이페이지 (My Page):**
    - [x] `src/services/orderService.ts`: `getOrders` 함수 구현 <!-- id: 18 -->
    - [x] `src/services/ootdService.ts`: `getUserOOTDPosts` 함수 구현 <!-- id: 19 -->
    - [x] `src/components/MyPage/OrderHistory.tsx`: 주문 내역 컴포넌트 구현 <!-- id: 20 -->
    - [x] `src/components/MyPage/MyOOTD.tsx`: 내 OOTD 컴포넌트 구현 <!-- id: 21 -->
    - [x] `src/pages/MyPage.tsx`: 탭 UI 및 컴포넌트 통합 <!-- id: 22 -->
    - [x] `src/pages/ProductDetail.tsx`: 최근 본 상품 로컬 스토리지 저장 로직 추가 <!-- id: 23 -->
    - [x] `src/components/MyPage/RecentlyViewed.tsx`: 최근 본 상품 컴포넌트 구현 <!-- id: 24 -->
    - [x] `src/pages/MyPage.tsx`: 최근 본 상품 탭 추가 <!-- id: 25 -->
- [x] **위시리스트 및 리뷰:**
